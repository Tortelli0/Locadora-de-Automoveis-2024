...
namespace LocadoraAutomoveis.WebApp.Models;
	...
	public class FormularioPlanoCobrancaViewModel
	{
		...
		[Range(0.01, double.MaxValue,
			ErrorMessage = "Os quilômetros disponíveis no plano controlado devem ser maiores que 0")]
		...
		[Range(0.01, double.MaxValue,
			ErrorMessage = "O preço por quilômetro extrapolado no plano controlado deve ser maior que 0")]
